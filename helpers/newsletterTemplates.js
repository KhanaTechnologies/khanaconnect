...
const NEWSLETTER_TEMPLATES = [
  ...
  {
    id: 'khana_sponsor_feature',
    name: 'Sponsor Feature',
    category: 'sponsorship',
    collection: KHANA_COLLECTION,
    description: 'Lead with a sponsor card, then your newsletter content.',
    previewImage: null,
    schema: { fields: [] },
    htmlStructure: '<!-- heading + sponsor + content -->',
  },
  {
    id: 'khana_sponsor_spotlight',
    name: 'Sponsor Spotlight',
    category: 'sponsorship',
    collection: KHANA_COLLECTION,
    description: 'Campaign image plus a full partner spotlight banner.',
    previewImage: null,
    schema: { fields: [] },
    htmlStructure: '<!-- image + heading + sponsor banner -->',
  },
  {
    id: 'khana_sponsor_duo',
    name: 'Sponsor Duo',
    category: 'sponsorship',
    collection: KHANA_COLLECTION,
    description: 'Two sponsor cards stacked, then room for your updates.',
    previewImage: null,
    schema: { fields: [] },
    htmlStructure: '<!-- two sponsor cards + content -->',
  },
  {
    id: 'khana_sponsor_footer',
    name: 'Sponsored Edition',
    category: 'sponsorship',
    collection: KHANA_COLLECTION,
    description: 'Normal newsletter layout with a sponsor strip at the bottom.',
    previewImage: null,
    schema: { fields: [] },
    htmlStructure: '<!-- content + footer sponsor -->',
  },
];
